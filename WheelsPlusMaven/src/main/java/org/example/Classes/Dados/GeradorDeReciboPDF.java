package org.example.Classes.Dados;
...
public class GeradorDeReciboPDF {
    ...
    /**
     * NOVO MÉTODO: Envia o recibo em PDF por email para o cliente.
     */
    public static void enviarPorEmail(Aluguel aluguel, String caminhoPdf) throws MessagingException {
        ...
        props.put("mail.smtp.socketFactory.port", "465"); // Porta para SSL
        props.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory"); // Habilita SSL
        props.put("mail.smtp.auth", "true");
        props.put("mail.smtp.port", "465"); // Porta de conexão
        // --- FIM DA ALTERAÇÃO ---
        ...
        // ... (o restante do método para criar e enviar a mensagem permanece o mesmo)
