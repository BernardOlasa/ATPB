...
public class PainelPromocao extends JPanel {
    ...
    /**
     * NOVO MÉTODO: Recarrega a lista de bicicletas e atualiza a interface gráfica.
     */
    ...
    private void carregarBicicletas() {
        ...
        // Adiciona apenas bicicletas que não foram excluídas
        bicicletasTodasTemp.addAll(GerenciadorDeDados.bicicletas.stream()
